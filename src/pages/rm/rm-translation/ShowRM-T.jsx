...
export default function RMTranslationShow() {
  const { id } = useParams();
        ...
        <div className="w-full bg-white shadow-md rounded-lg p-8 flex flex-col items-center">
                ...
                <div className="grid grid-cols-2 gap-6">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      value={
                        data
                          ? `${data.language_from_name} - ${data.language_from_code}`
                          : ''
                      }
                      disabled
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      value={
                        data
                          ? `${data.language_to_name} - ${data.language_to_code}`
                          : ''
                      }
                      disabled
                      className="w-full rounded-select px-4 py-4 rounded-[15px] mb-6 text-[14px] border border-[#BBBBBB]"
          ...
          <div className="w-full flex justify-end mt-14">
            <Button
              ...
              onClick={() => navigate('/resource-manager/translation')}
            >
              <FloppyDisk
