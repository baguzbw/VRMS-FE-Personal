...
export default function RMVendorAdd() {
  useEffect(() => {
  ...
  const resourceoptions = [
    { value: 'VendorPKP', label: 'Vendor PKP' },
    { value: 'VendorNonPKP', label: 'Vendor Non PKP' },
  ];
  ...
  const handleSubmitResource = async () => {
    ...
    if (
      isFieldEmpty(vendorName) ||
      isFieldEmpty(picName) ||
      isFieldEmpty(whatsapp) ||
      isFieldEmpty(email) ||
      isFieldEmpty(contactVia) ||
      !selectedCountry ||
      !selectedState ||
      !selectedCity ||
    ...
    try {
      ...
      navigate(`/resource-manager/vendor/${vendorId}/attachments`);
    } catch (error) {
      console.error(
        'There was an error!',
              ...
              <div className="w-1/2 pr-4">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`w-full px-4 py-4 rounded-[15px] mb-6 text-[14px] border focus:outline-none ${
                      formSubmitted && isFieldEmpty(vendorName)
                ...
                <div className="relative">
                  ...
                  <input
                    type="text"
                    className={`w-full px-4 py-4 rounded-[15px] mb-6 text-[14px] border focus:outline-none ${
                      formSubmitted && isFieldEmpty(contactVia)
                        ? 'border-[#DC362E] focus:border-[#DC362E]'
                        : 'border-[#BBBBBB] focus:border-[#065BCC]'
                    }`}
              ...
              <div className="w-1/2 pl-4">
                ...
                <div className="relative">
                  ...
                  <input
                    type="text"
                    className={`w-full px-4 py-4 rounded-[15px] mb-6 text-[14px] border focus:outline-none ${
                      formSubmitted && isFieldEmpty(picName)
                        ? 'border-[#DC362E] focus:border-[#DC362E]'
                        : 'border-[#BBBBBB] focus:border-[#065BCC]'
                    }`}
